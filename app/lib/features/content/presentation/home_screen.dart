  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        // ── 3. Breaking strip (the news ticker bar that used to live
        //      here was hidden for a cleaner home — payload.ticker is
        //      still fetched but not rendered) ──
        ...
        // ── 10. Trending — moved down from the top of the screen to
        //      reduce visual noise above the fold. Chips still scroll
        //      horizontally; tapping a tag goes to /search?q=<tag>. ──
...
class _CategoriesBoxState extends ConsumerState<_CategoriesBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          // ── Header (Icon + "الأقسام" label + live badge) was removed
          //      per UX request — the pills+content below are self-
          //      explanatory and the extra row was eating useful screen
          //      space above the fold. `color` is kept in scope for the
          //      pill highlight and content cards below. ──
