...
static_page_open(
    'سياسة التصحيح',
    'كيف يستقبل نيوزفلو بلاغات الأخطاء، يراجعها، ويُصحّحها بشفافية. خطوات الإبلاغ وأوقات الاستجابة.',
    'corrections',
    '١٩ نيسان/أبريل ٢٠٢٦'
);
?>
...
<ul>
  <li><strong>رابط الخبر</strong> الذي تقصده على نيوزفلو.</li>
...
<ul>
  ...
  <li><strong>حذف الخبر كاملًا</strong> من نيوزفلو في الحالات الخطيرة (خبر زائف بالكامل أو يُشكّل ضررًا).</li>
...
<div class="sp-callout">
  الصحافة الجيّدة تعترف بأخطائها بوضوح. نقدّر تعاونك في الحفاظ على دقّة ما يُنشر على نيوزفلو.
</div>
