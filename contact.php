...
static_page_open(
    'اتصل بنا',
    'طرق التواصل مع فريق نيوز فيد — استفسارات عامة، بلاغات تصحيح، طلبات صحفية، واقتراح مصادر جديدة.',
    'contact',
    '١٩ نيسان/أبريل ٢٠٢٦'
);
?>
...
<div class="sp-callout">
  <strong>ملاحظة:</strong> نيوز فيد منصّة تجميع أخبار، لا نحرّر أو ننشر الأخبار بأنفسنا. إذا كانت لديك شكوى عن محتوى خبر منشور من جهة أخرى، يُفضَّل التواصل مع المصدر الأصلي المذكور في أعلى بطاقة الخبر. أما إذا كانت المشكلة في العرض عندنا (ملخّص خاطئ، عنوان مُضلّل، تصنيف خاطئ) فراسلنا ونعالجها فورًا.
</div>
