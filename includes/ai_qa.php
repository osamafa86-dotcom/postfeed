<?php
/**
 * نيوزفلو - AI Q&A over the news archive
 * ========================================
...
function qa_call_claude(string $question, string $context, array $id_map): array {
    ...
    if (trim($context) === '') {
        return [
            'ok'       => true,
            'answer'   => 'لم أجد في أرشيف نيوزفلو مقالات ذات صلة مباشرة بسؤالك. جرّب صياغة أخرى أو استخدم كلمات مفتاحية مختلفة.',
            'cited'    => [],
            'follow_ups' => [],
        ];
    }

    $prompt = "أنت مساعد ذكي لموقع نيوزفلو الإخباري العربي. مهمتك الإجابة عن سؤال القارئ "
