...
// Sources change only when an admin edits the catalog (or cron updates
// articles_today). 5min cache is fine — even with stale follower counts,
// the cost is just slightly outdated chip ordering.
$out = cache_remember('api:sources:v1', 300, function () {
    $db = getDB();
